 ...
 * data it explains. It is the page's only explanation of what the numbers
 * mean, so it uses TapTooltip: a hover-only tooltip would hide it from
...
function MethodologyTooltip() {
  return (
    <span className="inline-flex translate-y-[3px]">
      <TapTooltip
        contentClassName="w-80 max-w-[calc(100vw-2rem)] px-3 py-2.5 text-[11px] leading-relaxed text-[#a9adb6]"
        content={
          <>
